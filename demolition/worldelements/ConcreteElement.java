...
public class ConcreteElement extends WorldElement
{
	@Override
	...
	{
		stateAtlasMap.put(DamageState.NONE, Assets.atlas.findRegion("concrete"));
		stateAtlasMap.put(DamageState.MODERATE, Assets.atlas.findRegion("concrete"));
		stateAtlasMap.put(DamageState.HEAVY, Assets.atlas.findRegion("concrete"));
	}
