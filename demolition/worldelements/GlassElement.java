...
public class GlassElement extends WorldElement
{
	@Override
	...
	public void createStateTextureMap()
	{
		...
		stateAtlasMap.put(DamageState.MODERATE, Assets.atlas.findRegion("wood"));
		stateAtlasMap.put(DamageState.HEAVY, Assets.atlas.findRegion("wood"));
	}
