...
public class SteelElement extends WorldElement
{
	@Override
	...
	{
		stateAtlasMap.put(DamageState.NONE, Assets.atlas.findRegion("steel"));
		stateAtlasMap.put(DamageState.MODERATE, Assets.atlas.findRegion("steel"));
		stateAtlasMap.put(DamageState.HEAVY, Assets.atlas.findRegion("steel"));
	}
