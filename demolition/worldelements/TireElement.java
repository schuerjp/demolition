...
public class TireElement extends WorldElement
{
	@Override
	...
	{
		stateAtlasMap.put(DamageState.NONE, Assets.buttonAtlas.findRegion("tire"));
		stateAtlasMap.put(DamageState.MODERATE, Assets.buttonAtlas.findRegion("tire"));
		stateAtlasMap.put(DamageState.HEAVY, Assets.buttonAtlas.findRegion("tire"));
	}
