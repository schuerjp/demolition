...
public class WoodElement extends WorldElement
{
	...
	{
		stateAtlasMap.put(DamageState.NONE, Assets.atlas.findRegion("wood"));
		stateAtlasMap.put(DamageState.MODERATE, Assets.atlas.findRegion("wood_moderate"));
		stateAtlasMap.put(DamageState.HEAVY, Assets.atlas.findRegion("wood_heavy"));
	}
